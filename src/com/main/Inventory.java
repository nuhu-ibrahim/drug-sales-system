...
public class Inventory extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(760, 350));
        ...
        jLabel4.setText("ADD DRUG TO INVENTORY");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 540, 40));
        ...
        add(productName, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 210, 380, -1));
        ...
        add(qty, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 250, 380, -1));
        ...
        add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 300, 190, 35));
        ...
        add(productID1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 170, 380, -1));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        if(this.productID1.getText().equals("") || this.productName.getText().equals("") || this.qty.getText().equals("")){
            ...
            try{
                ...
                st.setInt(1, (Integer.parseInt(qty)+ oldQty));
                ...
                st.setInt(3, Integer.parseInt(qty));
                st.setInt(4, 0);
                st.setString(5, "IN");
