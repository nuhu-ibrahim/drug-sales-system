...
public class ViewInventory extends javax.swing.JPanel {
     ...
     */
    Options main;
    public ViewInventory(Options main) {
        this.main=main;
        DBConnect.connect();
        initComponents();
        createTable();
    ...
    private void createTable(){
        String sql="select inventory.productID, productName, qty from product, inventory where product.productID = inventory.productID";

        JTable table;
        TableColumn column = null;
        JScrollPane scrollPane;
        String meta[]={"Drug ID", "Drug Name", "Quantity in Stock"};
        ...
        contentPanel.add(scrollPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 590, 200));
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(713, 419));
        setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        contentPanel.setBackground(new java.awt.Color(255, 255, 255));
        contentPanel.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        contentPanel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        add(contentPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 590, 200));
        ...
        add(compute2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 250, 180, 40));
        ...
        jLabel4.setText("VIEW INVENTORY REPORT");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 560, 40));

        add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 700, 40));
