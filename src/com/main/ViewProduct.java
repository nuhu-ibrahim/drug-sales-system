...
public class ViewProduct extends javax.swing.JPanel {
     ...
     */
    Options main;
    public ViewProduct(Options main) {
        this.main=main;
        DBConnect.connect();
        initComponents();
        createTable();
    ...
    private void createTable(){
        String sql="select productID, productName, charge from product";
       
        JTable table, table1;
        TableColumn column = null;
        JScrollPane scrollPane;
        
        String meta[]={"Drug ID", "Drug Name", "Charge per Drug"};
    ...
    private void initComponents() {
        ...
        jLabel4.setText("VIEW ALL DRUGS");
